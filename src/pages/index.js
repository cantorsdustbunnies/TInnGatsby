      ...
      <section className={styles.main}>
        <h3 className={styles.blurb}>
          <div>
            ...
            <div>
              Affordable,
              <div className={styles.name}>Travel Inn</div>
            </div>
          </div>
        </h3>
        <div className={styles.tInnHistory}>
          <p>
            ...
            great for exploring Laramie&apos;s unique history and vibrant
            nightlife. Within walking distance to restaurants, museums, fitness
            and more you&apos;ll be glad you stayed with us. Family owned and
            operated, our friendly staff is happy to help with whatever you
            need.
          </p>
        </div>
      </section>
        ...
        <div className={styles.neighborhoodInfo}>
          ...
          <div className={styles.nInfoBlurb}>
            ...
            <p>
              ...
              plan your next move, Whether you&apos;re here for a game, or just
              need a bite to eat, it&apos;s all in walking distance.
            </p>
